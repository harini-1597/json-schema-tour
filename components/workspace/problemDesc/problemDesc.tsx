	...
	<div className="min-h-screen bg-white text-black p-8">
		...
		<div className="text-lg">
      		<ul className="list-disc ml-6">
        		<li><a href="https://example.com" className="text-blue-500 mb-2">Creating a schema definition</a></li>
        		<li><a href="https://example.com" className="text-blue-500 mb-2">Defining properties</a></li>
        		<li><a href="https://example.com" className="text-blue-500 mb-2">Validating JSON data against the schema</a></li>
      		</ul>
    	</div>
		<div className="h-auto mb-7"></div>
		...
		<ul>
			<li><HiChevronDoubleRight className='text-2xl inline-block' /> to go to the next page or</li>
			<li><HiChevronDoubleLeft className="text-2xl inline-block" /> to go to the previous page</li>
		</ul>
		<div className="h-auto mb-3"></div>
